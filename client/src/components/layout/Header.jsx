...
const Header = () => {
  return (
    <header className="w-full border-b-2 border-black bg-white font-['Inter'] sticky top-0 z-50">
      <div className="flex items-center justify-between w-full px-6 py-4 max-w-7xl mx-auto">
        <div>
          <h1 className="text-xl md:text-2xl font-extrabold uppercase text-black tracking-tighter">
            Ezy Convert
          </h1>
        </div>
        <div className="flex items-center gap-4">
          ...
          <button className="relative cursor-pointer overflow-hidden px-6 py-2.5 text-sm font-bold tracking-wide text-white bg-black border-2 border-black transition-all duration-300 hover:bg-[#333333] outline-none active:scale-95 after:absolute after:inset-0 after:content-[''] after:bg-[radial-gradient(circle,rgba(255,255,255,0.25)_0%,rgba(255,255,255,0)_70%)] after:scale-0 after:transition-transform after:duration-500 hover:after:scale-[4]">
            Convert
          </button>
        </div>
      </div>
